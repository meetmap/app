    ...
    <View style={{gap: 6}}>
      ...
      <FlatList
        ...
        ListHeaderComponent={
          <StyledCreateTicket
            onPress={() =>
              navigation.navigate('CreateTicketModal', {ticketIndex: undefined})
            }
        ...
        renderItem={({item, index}) => (
          <PrimaryTicket
            onPress={() =>
              navigation.navigate('CreateTicketModal', {ticketIndex: index})
            }
            ticket={item}
          />
        )}
...
const StyledCreateTicket = styled(TouchableOpacity)`
  border: solid 1px
    ${props => props.theme.colors.BUTTON.Secondary.BorderDefault};
  width: 200px;
  height: 150px;
  gap: 6px;
  padding: 16px;
